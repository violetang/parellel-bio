 ...
 *   - CMAKE_1ARRAY(a,n)             make a 1D array of length "n", using calloc
 *   - MAKE_2ARRAY(a,m,n)            make a 2D array of dimensions "m x n"
 *   - CMAKE_2ARRAY(a,m,n)           make a 2D array of dimensions "m x n"
 *   - MAKE_3ARRAY(a,l,m,n)          make a 3D array of dimensions "l x m x n"
 *   - CMAKE_3ARRAY(a,l,m,n)         make a 3D array of dimensions "l x m x n"
 *   - MAKE_4ARRAY(a,k,l,m,n)        make a 4D array of dimensions "k x l x m x n"
 *   - CMAKE_4ARRAY(a,k,l,m,n)       make a 4D array of dimensions "k x l x m x n"
 *   - MAKE_2JAGGED_ARRAY(a,m,v)     make a 2D jagged array; v is array of len m
 *   - CMAKE_2JAGGED_ARRAY(a,m,v)    make a 2D jagged array; v is array of len m
 *   - MAKE_3JAGGED_ARRAY(a,m,n,v)   make a 3D jagged matrix; v is array of len n
 *   - CMAKE_3JAGGED_ARRAY(a,m,n,v)  make a 3D jagged matrix; v is array of len n
 *   - COPY_1ARRAY(a,b,n)            copy a 1D array of length n
 *   - COPY_2ARRAY(a,b,n)            copy a 2D array of length "any x n"
 *   - COPY_3ARRAY(a,b,n)            make a 3D array of dimensions "any x any x n"
 *   - COPY_4ARRAY(a,b,n)            make a 4D array of dimensions "any x any x any x n"
 *   - COPY_2JAGGED_ARRAY(a,b,v)     make a 2D jagged array; v is array of len m
 *   - COPY_3JAGGED_ARRAY(a,b,v)     make a 3D jagged matrix; v is array of len n
 *
...
#define CMAKE_1ARRAY MAKE_1ARRAY_DEFAULT
...
#define COPY_1ARRAY(a,b,n) do {                                                \
	...
	if ((a) == NULL)                                                       \
		fprintf(stder, "*** in file %s, function %s(), line %d: "      \
			"memcpy failed!\n", __FILE__, __func__, __LINE__);     \
} while (0)
